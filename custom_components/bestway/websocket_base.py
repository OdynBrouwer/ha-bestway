...
class BaseWebSocketClient:
    ...
    async def connect(self) -> None:
        """Connect and keep retrying until disconnect(); subclass hook."""
    ...
    async def _schedule_reconnect(self) -> None:
        ...
        A loop rather than connect() calling itself: the endpoint can stay
        unreachable for as long as the device is offline, and a recursive chain
        would add a stack frame per attempt.
        """
